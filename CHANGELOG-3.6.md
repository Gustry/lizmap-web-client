...
* Lizmap Web Client won't display some QGIS project if:
  * The CFG file is too old according to the Lizmap Web Client target version defined in QGIS Desktop
  * The QGIS desktop version is higher than the QGIS server version
